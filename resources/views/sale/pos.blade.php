            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5">
                            <button style="background-color: #5f27cd" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="gift-card-btn"><i class="fa fa-credit-card-alt"></i> {{trans('file.GiftCard')}}</button>
                        </div>
                         <div class="column-5">
                ...
                <div class="filter-window">
                    <div class="category mt-3">
                        <div class="row ml-2 mr-2 px-2">
                            <div class="col-7">{{trans('file.Choose category')}}</div>
