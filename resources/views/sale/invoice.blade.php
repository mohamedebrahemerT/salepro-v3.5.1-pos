        ...
        <table class="table-data">
            ...
            <!-- <tfoot> -->
                ...
                <tr>
                    ...
                    <th class="centered" colspan="3">{{trans('file.In Words')}}: <span>{{$currency->code}}</span>  </th>
                    @else
                    <th class="centered" colspan="3">{{trans('file.In Words')}}:  <span>{{$currency->code}}</span></th>
                    @endif
                </tr>
        ...
        <table>
            <tbody>
                ...
                <tr style="background-color:#ddd;">
                    ...
                    <td style="padding: 5px;width:40%">{{trans('file.grand total')}}: {{number_format((float)$payment_data->amount, 2, '.', '')}}</td>
