...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo asset('public/css/custom-'.$general_setting->theme) ?>" type="text/css" id="custom-style">
            ...
            <link rel="stylesheet" type="text/css" href="{{url('/')}}/public/vendor/bootstrap/css/bootstrap-rtl.min.css">

              <link rel="stylesheet" type="text/css" href="{{url('/')}}/public/vendor/bootstrap/css/custom-rtl.css">
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                @if(Auth::user()->role_id != 5)
                <li class="nav-item"> 
                    <a class="dropdown-item" href="https://www.facebook.com/profile.php?id=100004263150022" target="_blank"><i class="dripicons-information"></i> {{trans('file.Help')}}</a>
                </li>
                @endif
                <li class="nav-item">
