...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('category')->with('message', trans('file.Category inserted successfully'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('category')->with('message', trans('file.Category updated successfully'));
    }
    ...
    public function destroy($id)
    {
        ...
        if($lims_category_data->image)
            unlink('public/images/category/'.$lims_category_data->image);
        $lims_category_data->save();
        return redirect('category')->with('not_permitted',trans('file.Category deleted successfully'));
    }
}
