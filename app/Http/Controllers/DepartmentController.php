...
class DepartmentController extends Controller
{
 ...
 return redirect('departments')->with('message', trans('file.Department created successfully'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('departments')->with('message', trans('file.Department updated successfully') );
    }
    ...
    public function deleteBySelection(Request $request)
    {
        ...
        return   trans('file.Department deleted successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_department_data->is_active = false;
        $lims_department_data->save();
        return redirect('departments')->with('message', trans('file.Department deleted successfully'));
    }
}
