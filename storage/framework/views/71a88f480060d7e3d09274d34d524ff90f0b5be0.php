...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo asset('public/css/custom-'.$general_setting->theme) ?>" type="text/css" id="custom-style">
            ...
            <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/vendor/bootstrap/css/bootstrap-rtl.min.css">

              <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/vendor/bootstrap/css/custom-rtl.css">
...
<link href="https://fonts.googleapis.com/css2?family=Cairo:wght@600;700&display=swap" rel="stylesheet"> 
  ...
  <body onload="myFunction()" style="font-family: 'Cairo', sans-serif;">
    <div id="loader"></div>
      <!-- Side Navbar -->
        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li class=""><a href="#hrm" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-user-group"></i><span><?php echo e(trans('file.HRM')); ?></span></a>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <?php if(Auth::user()->role_id != 5): ?>
                <li class="nav-item"> 
                    <a class="dropdown-item" href="https://www.facebook.com/profile.php?id=100004263150022" target="_blank"><i class="dripicons-information"></i> <?php echo e(trans('file.Help')); ?></a>
                </li>
                <?php endif; ?>
                <li class="nav-item">
...
</html><?php /**PATH C:\xampp\htdocs\dashboard\salepro-v3.5.1\salepro\resources\views/layout/main.blade.php ENDPATH**/ ?>