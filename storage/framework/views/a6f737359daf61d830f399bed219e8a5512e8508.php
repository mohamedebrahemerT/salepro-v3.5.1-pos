        ...
        <table class="table-data">
            ...
            <!-- <tfoot> -->
                ...
                <tr>
                    ...
                    <th class="centered" colspan="3"><?php echo e(trans('file.In Words')); ?>: <span><?php echo e($currency->code); ?></span>  </th>
                    <?php else: ?>
                    <th class="centered" colspan="3"><?php echo e(trans('file.In Words')); ?>:  <span><?php echo e($currency->code); ?></span></th>
                    <?php endif; ?>
                </tr>
        ...
        <table>
            <tbody>
                ...
                <tr style="background-color:#ddd;">
                    <td style="padding: 5px;width:30%"><?php echo e(trans('file.Paid By')); ?>:
                    <?php if($payment_data->paying_method == 'Cash'): ?> 
                         <?php echo e(trans('file.cash')); ?>


                        <?php else: ?>
                        <?php echo e($payment_data->paying_method); ?>


                        <?php endif; ?>
                    </td>
                    <td style="padding: 5px;width:40%"><?php echo e(trans('file.grand total')); ?>: <?php echo e(number_format((float)$payment_data->amount, 2, '.', '')); ?></td>
...
<?php /**PATH C:\xampp\htdocs\dashboard\salepro-v3.5.1\salepro\resources\views/sale/invoice.blade.php ENDPATH**/ ?>