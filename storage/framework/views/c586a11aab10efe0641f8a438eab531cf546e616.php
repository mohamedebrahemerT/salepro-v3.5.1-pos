          ...
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <?php echo e(Form::select('parent_id', $lims_categories, null, ['class' => 'form-control','placeholder' => trans('file.No Parent Category')])); ?>
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                    if(user_verified == '1') {
                        ...
                        if(category_id.length && confirm("trans('file.If you delete category all products under this category will also be deleted. Are you sure want to delete?')")) {
                            $.ajax({
                                type:'POST',
                            ...
                            alert('<?php echo e(trans("file.No category is selected!")); ?>');
                    }
                    else
                        alert('trans("admin.This feature is disable for demo!")');
                }
            },
            {
                extend: 'colvis',
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\salepro-v3.5.1\salepro\resources\views/category/create.blade.php ENDPATH**/ ?>